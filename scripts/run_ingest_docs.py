...
from rag_info_extractor.document_ingestion.ingest_docs import load_docs_from_dir, save_parent_chunk_bytes, embed_child_chunks
...
def main():
    ...
    DOC_STORE_LARGE_CHUNKS_PATH = os.path.join(BASE_DIR, "data", "large_chunks_dbs", DATASET_TYPE, f"{CHUNKS_TYPE}")  
    VECTOR_STORE_PATH = os.path.join(BASE_DIR, "data", "vector_dbs", DATASET_TYPE, f"{CHUNKS_TYPE}") 
